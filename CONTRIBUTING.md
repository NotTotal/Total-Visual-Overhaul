...
Once pushed, go to the [Pull request](https://github.com/jdsmith2816/eldersouls/pulls) page and create a new PR by clicking the green `New pull request` button in the top right corner. Select `base: master` and `compare: branch-name`. Click `Create pull request` to create the PR.
...
`git remote add upstream https://github.com/jdsmith2816/eldersouls.git`
